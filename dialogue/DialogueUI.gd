...
#---File---#
export var JSONFilename : String = "Only JSON Filename"
var file_name = JSONFilename # You could pass a new file here on area body enter or whenever you feel like
...
#------UI--------#
onready var dialogueText = $MarginContainer/HBoxContainer/VBoxContainer/DialogueText
onready var dialoguePanel = self #Less rewritting if you want to move the script to another object
onready var dialogueName = $MarginContainer/HBoxContainer/VBoxContainer/DialogueName
onready var dialogueButtons = [$MarginContainer/HBoxContainer/VBoxContainer2/DialogueButton,$MarginContainer/HBoxContainer/VBoxContainer2/DialogueButton2,$MarginContainer/HBoxContainer/VBoxContainer2/DialogueButton3,$MarginContainer/HBoxContainer/VBoxContainer2/DialogueButton4]
...
func UpdateUI():
	if curent_node_id >= 0:
		...
		if curent_node_name == "player_name":
			dialogueName.text = "Zbyszek"
		else:
